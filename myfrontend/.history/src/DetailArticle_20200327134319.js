...
toast.configure();
const COMMENTBOX_KEY = '5661504607092736-proj1';
                        ...
                        <div className="col-12 mt-3">
                            <div className="card">
                                <div className="card-veritical">
                                    ...
                                    {/* <div className={"commentbox"} id={"https://www.nytimes.com/2020/03/27/world/coronavirus-news.html"} ref={this.elementDidMount.bind(this)}></div> */}

...
class DetailArticle extends Component{
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            id: "",
            // web_url: "",
            web_url: new URLSearchParams(window.location.search).get('web_url'),
    ...
    render() {
        ...
        return (
                <div className={"commentbox"} id={"1234-a"} ref={this.elementDidMount}></div>
        )

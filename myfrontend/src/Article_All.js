...
export default class Article_All extends Component {
    ...
    async componentDidMount() {
        ...
        const url = "/article?id=0&web_url=https://www.nytimes.com/2020/04/06/world/coronavirus-live-news-updates.html";
        const response = await fetch(url);
        const data = await response.json();
        this.setState({data: JSON.stringify(data.temp)});

        const url2 = "/article?id=sport/blog/2020/apr/07/talking-horses-a-win-for-the-north-as-brian-hughes-is-champion-jockey";

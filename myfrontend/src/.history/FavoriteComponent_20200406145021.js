                ...
                <div class="col-sm-12 col-lg-3 px-1 py-1">
                    <div class="p-2 shadow card" onClick={event => this.state.modalShow ?
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-4 text-left p-0" style={{position:'none',marginLeft:0, paddingRight:0,marginRight:0 }}>{this.props.news.date}</div>
                                <div class="col-8 text-right p-0" style={{position:'none',marginLeft:0, paddingRight:0,marginRight:0}}>

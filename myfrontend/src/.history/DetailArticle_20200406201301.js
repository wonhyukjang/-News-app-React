...
class DetailArticle extends Component {
    ...
    async componentDidMount() {
        ...
        var url = '';
        if (query.web_url) {
            url = "http://Nodeserver-env-1.eba-4mmhkpip.us-west-2.elasticbeanstalk.com/article?id=" + query.id + '&web_url=' + query.web_url;
            this.setState({Guardian: false})
            this.setState({check: false})
        } else {
            url = "http://Nodeserver-env-1.eba-4mmhkpip.us-west-2.elasticbeanstalk.com/article?id=" + query.id;

...
class Search extends Component {
    ...
    async componentDidMount() {
        ...
        var url = ''
        if (this.state.check)
            url = 'http://Nodeserver-env-1.eba-4mmhkpip.us-west-2.elasticbeanstalk.com/Search?id=' + query.q + '&source=guardian';
        else
            url = 'http://Nodeserver-env-1.eba-4mmhkpip.us-west-2.elasticbeanstalk.com/Search?id=' + query.q + '&source=ny';

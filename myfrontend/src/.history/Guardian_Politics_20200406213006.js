...
export default class Guardian_Politics extends Component {
    constructor(props) {
        super(props)
    ...
    async componentDidMount() {
        const url = "https://Nodeserver-env-1.eba-4mmhkpip.us-west-2.elasticbeanstalk.com/Guardian_Politics";

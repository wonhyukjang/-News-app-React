                ...
                <Navbar id = "navbar" collapseOnSelect expand="lg" bg="primary" variant="dark">
                    ...
                    <Navbar.Collapse id="responsive-navbar-nav">
                        <Nav className="mr-auto">
                            ...
                            <NavLink  onClick = {this.state.selectedResult != null ?this.clear(): null} className={'nav-link'} activeClassName={'active'} exact to="/">Home</NavLink>
                            <NavLink  onClick = {this.state.selectedResult != null ?this.clear(): null} className={'nav-link'} activeClassName={'active'} exact to="/World">World</NavLink>
                            <NavLink  onClick = {this.state.selectedResult != null ?this.clear(): null} className={'nav-link'} activeClassName={'active'} exact to="/Politics">Politics</NavLink>
                            <NavLink onClick = {this.state.selectedResult != null ?this.clear(): null} className={'nav-link'} activeClassName={'active'} exact to="/Business">Business</NavLink>
                            <NavLink  onClick = {this.state.selectedResult != null ?this.clear(): null} className={'nav-link'} activeClassName={'active'} exact to="/Technology">Technology</NavLink>
                            <NavLink  onClick = {this.state.selectedResult != null ?this.clear(): null} className={'nav-link'} activeClassName={'active'} exact to="/Sports">Sports</NavLink>

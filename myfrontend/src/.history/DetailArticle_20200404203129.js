...
//                                 <strong id = 'dropdown' onClick = {this.showMoreHandler}>{this.state.mark}</strong>
    showMoreHandler(e) {
        ...
        //   }));
        // console.log("State: ",this.state.showMore)

        // debugger;
        // if(this.state.showMore) {                                            
        //     if(this.myDivToFocus_second.current){
        //         this.myDivToFocus_second.current.scrollIntoView({ 
        //             behavior: "smooth", 
        //             block: "nearest"
        //         })
        //     }   
        // } else {
        //     if(this.myDivToFocus_first.current){
        //         this.myDivToFocus_first.current.scrollIntoView({ 
        //             behavior: "smooth", 
        //             block: "nearest"
        //         })
        //     } 
                                    ...
                                    <div className="card">
                                        <div className="card-veritical">
                                            <div className="titles">
                                                <h4 className="card-title" style={{fontWeight: 'bold'}}>{this.state.Guardian ? this.state.data.webTitle : this.state.data.docs[0].headline.main}</h4>

                                                <div class="row">
                                                    <div class="col-4 text-left" style={{marginTop: 5, fontSize: 14}}>

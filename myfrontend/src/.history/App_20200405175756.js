...
if(!JSON.parse(localStorage.get('search'))) {
    localStorage.setItem('search', JSON.stringify('none'))
...
class App extends Component {
    constructor() {
        ...
        this.state = {
            ...
            query : JSON.parse(localStorage.getItem('search')) === 'Guardian' ? true : false
            // search: ""
        }
    ...
    // }, [selectAPI]);
    changeSearch(props) {
        localStorage.setItem('search', JSON.stringify(props))
    }
    changeSwitch() {
        ...
        return (
            <Router>
                <Form_Main changeLink={this.onChange.bind(this)} check={this.props.check} 
                                        ...
                                        bookmark={this.state.bookmark} closeBookmark = {this.closeBookmark.bind(this)} query={this.state.query} setQuery={this.changeSearch.bind(this)}/>
                ...
                <Switch>
                    ...
                    <Route path='/Search' exact component={() => <Search start={this.state.isDisplay} checked={this.state.check} changeSwitch = {this.changeStart.bind(this)} showSwitch = {this.showSwitch.bind(this)}/>}/>

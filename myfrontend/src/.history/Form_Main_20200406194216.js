...
class Form_Main extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            isBookmark    : (window.location.pathname === 'Nodeserver-env-1.eba-4mmhkpip.us-west-2.elasticbeanstalk.com/favorites'),
            close         : false,
            search        : (window.location.pathname === 'Nodeserver-env-1.eba-4mmhkpip.us-west-2.elasticbeanstalk.com/search'),
    ...
    onSearchChange = (selectedOption) => {
        if (selectedOption) {
            ...
            //     pathname:'/search?q=' + selectedOption.val})
                ...
                this.props.history.push({
                pathname: "Nodeserver-env-1.eba-4mmhkpip.us-west-2.elasticbeanstalk.com/search?q=" + query
                });
    ...
    render() {
        ...
        console.log("Display Query: ", this.props.keyword)

            ...
            cardItem =
                <div class="col-sm-12 col-lg-3 px-1 py-1">
                    <div class="p-2 shadow card" onClick={event => this.state.modalShow ?
                        null :
                            this.state.source ?
                            this.props.history.push("Nodeserver-env-1.eba-4mmhkpip.us-west-2.elasticbeanstalk.com/article?id=" + this.props.news.id):
                            this.props.history.push("Nodeserver-env-1.eba-4mmhkpip.us-west-2.elasticbeanstalk.com/article?id=" + this.props.news.id + '&web_url=' + this.props.news.url)}>                                                   
                        ...
                        <div class="text-left mt-2 card-title h5" style={{fontStyle: FaItalic}}>
                            ...
                            <span class="card-text2" onClick={this.handleClick}><IoMdShare/></span>
                            <span class="card-text2" onClick={this.RemoveNews}><IoMdTrash/></span>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-4 text-left p-0" style={{fontStyle:'italic', fontSize: 15}}>{this.props.news.date}</div>

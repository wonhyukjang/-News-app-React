...
class App extends Component {
    constructor() {
        ...
        this.state = {
            ...
            query : JSON.parse(localStorage.getItem('select'))
        }
        ...
        return (
            <Router>
                <Form_Main changeLink={this.onChange.bind(this)} check={this.props.check} 
                                        ...
                                        bookmark={this.state.bookmark} closeBookmark = {this.closeBookmark.bind(this)} keyword={this.state.query} setQuery={this.changeSearch.bind(this)}/>

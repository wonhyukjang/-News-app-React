                    ...
                    <Navbar.Collapse id="responsive-navbar-nav">
                        ...
                        <Nav className="ml-auto">
                            <NavLink onClick={this.refresh.bind(this)} className={'nav-link'} activeClassName={'active'} exact to="/favorites">
                                {this.props.mark && (<OverlayTrigger placement="bottom" delay={{show: 250, hide: 400}} overlay={renderBookmark()}><FaBookmark className="bookmarkTop" style={{fontSize: 25}}/></OverlayTrigger>)}
                                {!this.props.mark && (<OverlayTrigger placement="bottom" delay={{show: 250, hide: 400}} overlay={renderBookmark()}><FaRegBookmark className="bookmarkTop" style={{fontSize: 25}}/></OverlayTrigger>)}
                            </NavLink>

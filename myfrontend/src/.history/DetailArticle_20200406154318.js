                                    ...
                                    <div className="card">
                                        <div className="card-veritical">
                                            <div className="titles">
                                                <h4 className="card-title" style={{fontWeight: '400', margin: 0, fontStyle: 'italic', fontSize: 20}}>{this.state.Guardian ? this.state.data.webTitle : this.state.data.docs[0].headline.main}</h4>

...
class App extends Component {
    ...
    render() {
        ...
        console.log("IsDisplay",this.state.isDisplay)
        this.changeSwitch()
        return (
            <Router>
                <Form_Main changeLink={this.onChange.bind(this)} check={this.props.check} isDisplay={this.state.isDisplay} changeSwitch = {this.changeSwitch.bind(this)}/>

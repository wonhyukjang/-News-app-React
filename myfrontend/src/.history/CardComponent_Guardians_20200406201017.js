            ...
            <span class="row">
                <div class="col-12 mt-3">
                    <div class="card" onClick={event => this.state.modalShow ? 
                                                                null : 
                                                                this.state.source ? 
                                                                this.props.history.push('http://Nodeserver-env-1.eba-4mmhkpip.us-west-2.elasticbeanstalk.com/article?id=' + this.props.news.id):
                                                                this.props.history.push("http://Nodeserver-env-1.eba-4mmhkpip.us-west-2.elasticbeanstalk.com/article?id=" + this.props.news.id + 
                        ...
                        <div class="card-horizontal">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text" style={{color:'#000000'}}>{this.props.news.blocks.body[0].bodyTextSummary}</p>
                                <p class="card-date">
                                    <span style={{fontStyle:'italic', color: {r:5,g:87,b:87}, fontWeight:500}}>{this.props.news.webPublicationDate}</span>
                                    <Badges id='badge1' badge = {this.props.news.section.length > 0 ? this.props.news.section: ""}/>
                                </p>
                            </div>
                        </div>
                    </div>

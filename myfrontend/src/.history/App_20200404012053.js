...
class App extends Component {
    ...
    render() {
        ...
        const mark  = !(window.location.pathname === '/favorites')
        console.log("IsDisplay",isDisplay)
        return (
            <Router>
                <Form_Main changeLink={this.onChange.bind(this)} check={this.props.check} isDisplay={isDisplay} mark={mark}/>
                ...
                <Switch>
                    ...
                    <Route path="/Favorites" exact component={Favorites} mark = {mark}/>

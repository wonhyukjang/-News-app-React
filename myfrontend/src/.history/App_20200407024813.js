...
import Guardian_All from "./Guardian_All"
import NY_All from "./NY_All"
import Search_All from "./Search_All"
import Article_All from "./Article_All"
        ...
        return (
            <Router>
                <Form_Main changeLink={this.onChange.bind(this)} check={this.props.check} 
                                        ...
                                        bookmark={this.state.bookmark} closeBookmark = {this.closeBookmark.bind(this)} keyword={this.state.queryString} setSearch={this.changeSearch.bind(this)}/>
                ...
                <Switch>
                    ...
                    <Route path="/World" exact component={this.state.check ?
                        () => <Guardian_World changeLink={this.onChange.bind(this)} check={this.state.check} start={this.state.start} changeSwitch = {this.changeStart.bind(this)}/>
                        : () => <Word_Card changeLink={this.onChange.bind(this)} check={this.state.check}/>}/>

                    <Route path="/Politics" exact component={this.state.check ?
                        () => <Guardian_Politics changeLink={this.onChange.bind(this)} check={this.state.check} start={this.state.start} changeSwitch = {this.changeStart.bind(this)}/>
                    ...
                    <Route path="/Business" exact component={this.state.check ?
                        () => <Guardian_Business changeLink={this.onChange.bind(this)} check={this.state.check} start={this.state.start} changeSwitch = {this.changeStart.bind(this)}/>
                    ...
                    <Route path="/Technology" exact component={this.state.check ?
                        () => <Guardian_Technology changeLink={this.onChange.bind(this)} check={this.state.check} start={this.state.start} changeSwitch = {this.changeStart.bind(this)}/>
                    ...
                    <Route path="/Sports" exact component={this.state.check ?
                        () => <Guardian_Sport changeLink={this.onChange.bind(this)} check={this.state.check} start={this.state.start} changeSwitch = {this.changeStart.bind(this)}/>
                    ...
                    <Route path="/article" exact component={() => <DetailArticle changeLink={this.onChange.bind(this)} checked={this.state.check} start={this.state.start} changeSwitch = {this.changeStart.bind(this)} openBookmark = {this.openBookmark.bind(this)}/>}/>
                    ...
                    setSearch={this.changeSearch.bind(this)}/>}/>

                    <Route path="/Guardian_All" exact component = {Guardian_All}/>
                    <Route path="/NY_All" exact component = {NY_All}/>
                    <Route path="/Search_All" exact component = {Search_All}/>    
                    <Route path="/Article_All" exact component = {Article_All}/>
                </Switch>
            </Router>
        );
    }

                    ...
                    <div className={"p-2 shadow card"} onClick={event => this.state.modalShow ?
                        null :
                            ...
                            this.state.source ?
                                ...
                                this.props.history.push("/article?id=" + this.props.news.id + '&web_url=' + this.props.news.direct)}>


                        <div className={"text-left mt-2 card-title h5"} style={{fontStyle: FaItalic}}>
                            <strong style={{fontSize: 15}}className={"pr-2"}>{this.props.news.titles}</strong>
                        ...
                        <div className={"card-body"}>
                            ...
                            <div className={"row"}>
                                <div className={"col-4 text-left p-0"} style={{marginTop: 5, fontStyle: 'italic', fontSize: 15}}>{this.props.news.date}</div>

                ...
                <div class="col-12 mt-3">
                    ...
                    <div class="card" onClick={event => this.state.modalShow ? 
                                                                ...
                                                                this.state.source ?
                                                                    ...
                                                                    this.props.history.push("http://Nodeserver-env-1.eba-4mmhkpip.us-west-2.elasticbeanstalk.com/article?id=" + this.props.news.id + '&web_url=' + this.props.news.url)                                                        
                                                                }>
                        ...
                        <div class="card-horizontal">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-date">
                                    <span style={{fontStyle:'italic', color: {r:5,g:87,b:87}, fontWeight:500}}>{this.props.news.published_date}</span>

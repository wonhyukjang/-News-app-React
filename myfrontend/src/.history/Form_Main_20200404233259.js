...
class Form_Main extends Component {
    ...
    closeNav() {
        document.getElementById('navbar').display = "block"
    }
    componentDidUpdate() {
                    ...
                    <Navbar.Collapse id="responsive-navbar-nav">
                        ...
                        <Nav className="ml-auto">
                            ...
                            {isDisplay && (<><span id="NY_Times">NY Times</span>
                                <SwitchTop class="navbar-nav ml-auto" changeLink={this.onChanges.bind(this)} check={this.props.check} changeExpand = {this.closeNav.bind(this)} collapseOnSelect/>

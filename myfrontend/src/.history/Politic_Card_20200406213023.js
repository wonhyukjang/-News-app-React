...
export default class Politic_Card extends Component {
    constructor() {
        super()
    ...
    async componentDidMount() {
        const url = "https://Nodeserver-env-1.eba-4mmhkpip.us-west-2.elasticbeanstalk.com/NY_Politics";
    ...
    render() {
        if (!this.state.loading){
            ...
            return (            
                <div>
                    {/* <Form_Main changeLink={this.handler.bind(this)}/> */}
                    {cardItems}
                </div>
            )
        } else {

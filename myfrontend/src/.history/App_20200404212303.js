...
class App extends Component {
    ...
    render() {
        ...
        return (
            <Router>
                <Form_Main changeLink={this.onChange.bind(this)} check={this.props.check} isDisplay={this.isDisplay} switch = {this.state.isDisplay}/>
                ...
                <Switch>
                    ...
                    <Route path="/Favorites" exact component={() => <Favorites start={this.state.start} changeSwitch = {this.changeStart.bind(this)} showSwitch = {this.showSwitch.bind(this)}/>}/>

                    <Route path="/article" exact component={() => <DetailArticle changeLink={this.onChange.bind(this)} checked={this.state.check} start={this.state.isDisplay} changeSwitch = {this.changeStart.bind(this)}/>}/>

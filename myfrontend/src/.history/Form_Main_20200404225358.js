...
class Form_Main extends Component {
    ...
    render() {
        ...
        return (
            <div className="App">
                <Navbar collapseOnSelect expand="lg" bg="primary" variant="dark" expanded={this.state.expand} onClick={() => {this.setState({expand: true}})>
                    <AsyncSelect
                        style={{minWidth: 250}}
                    ...
                    <Navbar.Collapse id="responsive-navbar-nav">
                        ...
                        <Nav className="ml-auto">
                            ...
                            {isDisplay && (<><span id="NY_Times">NY Times</span>
                                <SwitchTop class="navbar-nav ml-auto" changeLink={this.onChanges.bind(this)} check={this.props.check} changeExpand = {this.changeExpand.bind(this)}/>

    ...
    render() {
        ...
        return (
            <div className="App">
                ...
                {this.props.query && (<MyAsyncSelect query={query} setQuery={setQuery}/>)}
                {!this.props.query && (<MyAsyncSelect setQuery={setQuery}/>)}

                    <AsyncSelect
                        style={{minWidth: 250}}
                        defaultInputValue={this.props.query !== ''? this.props.query: ""}

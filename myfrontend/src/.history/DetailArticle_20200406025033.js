                                    ...
                                    <div className="card">
                                        <div className="card-veritical">
                                            <div className="titles">
                                                <h4 className="card-title" style={{fontWeight: 'bold', margin: 0, fontStyle: 'italic', fontSize: 15}}>{this.state.Guardian ? this.state.data.webTitle : this.state.data.docs[0].headline.main}</h4>

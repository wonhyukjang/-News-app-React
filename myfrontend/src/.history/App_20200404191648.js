            ...
            <Router>
                ...
                <Switch>
                    ...
                    <Route path="/" exact component={this.state.check ?
                        () => <Guardian_Home changeLink={this.onChange.bind(this)} check={this.state.check} start={this.state.start} changeSwitch = {this.changeSwitch.bind(this)}/>

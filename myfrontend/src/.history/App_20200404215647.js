...
class App extends Component {
    ...
    render() {
        ...
        return (
            <Router>
                <Form_Main changeLink={this.onChange.bind(this)} 
                            check={this.props.check} isDisplay={this.isDisplay} 
                            switch = {this.state.isDisplay} bookmark = {this.state.bookmark} 
                            changeMark = {this.closeBookmark.bind(this)} />

                    ...
                    <Navbar.Collapse id="responsive-navbar-nav">
                        ...
                        <Nav className="ml-auto">
                            <NavLink onClick={this.refresh_Favorites.bind(this)} className={'nav-link'} activeClassName={'active'} exact to="/favorites">
                                {this.props.isBookmark && (<OverlayTrigger placement="bottom" delay={{show: 250, hide: 400}} overlay={renderBookmark()}><FaBookmark className="bookmarkTop" style={{fontSize: 25}}/></OverlayTrigger>)}
                                {!this.props.isBookmark && (<OverlayTrigger placement="bottom" delay={{show: 250, hide: 400}} overlay={renderBookmark()}><FaRegBookmark className="bookmarkTop" style={{fontSize: 25}}/></OverlayTrigger>)}
                            </NavLink>

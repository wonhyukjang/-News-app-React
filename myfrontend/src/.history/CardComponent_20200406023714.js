                    ...
                    <div class="card" onClick={event => this.state.modalShow ? 
                        ...
                        <div class="card-horizontal">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-date">
                                    <span style={{fontStyle:'italic'}}>{this.props.news.published_date}</span>
                                    <Badges style={{marginTop:3}}badge = {this.props.news.section.length > 0 ? this.props.news.section : ""}/>
                                </p>
                            </div>
                        </div>
                        {/* </a> */}
